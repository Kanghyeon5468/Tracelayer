...
- Publish a short build article for the hackathon.
- Publish a social post with `#AllThingsAgenticHackathon`.
- Add a Gemma, Veo, or Lyria integration if it naturally strengthens the product.
